...
eval("\r\n/([^ ]*?) ([^ ]*?) \\[(.*?)\\] \\/(.*)\\//;\r\nasync function main() {\r\n    const data = await fetch('./cedict_ts.u8');\r\n    console.log(data);\r\n}\r\n\n\n//# sourceURL=webpack://tea/./src/main.ts?");
...
/******/ 	__webpack_modules__["./src/index.scss"](0, {}, __webpack_require__);
